	 	...
	 	function($timeout, $document, $interpolate, $swipe) {
            ...
            return {
                ...
                template: // bar background
                    ...
                    "<span class='bar steps  {{index}}'><span class='bubble step' ng-repeat='step in stepBubbles()'></span></span>" + // step bubbles
                    "<span class='bar selection'></span><span class='bar unselected low'></span><span class='bar unselected high'></span>" + // the knobs
                    "<span class='pointer low bfd-pointer'></span><span class='pointer high'></span>" + // current value bubbles
                    "<span class='bubble low bfd-txt'></span><span class='bubble high'></span><span class='bubble middle'></span><span class='bubble selection'></span>" + // low, high, middle and selection bubbles
                ...
                controller: function($scope, $timeout) {
                    ...
                    $timeout(function() {
                        setCSS($scope.ngModel);
                    });

                    function setCSS(data) {
                        angular.element('.' + $scope.index).css({
                            width: data + '%',
