...
![](https://sunny586.github.io/code/dist/mark-down/fe-interview/手写高质量代码/img/双向链表-1.png)

要把中间的元素 B 移动到最后（如 LRU `set` `get` 时移动数据位置），只需要修改前后的指针即可，效率很高。

![](https://sunny586.github.io/code/dist/mark-down/fe-interview/手写高质量代码/img/双向链表-2.png)
